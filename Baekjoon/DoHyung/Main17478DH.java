...
public class Main17478DH {
    public static final String UNDERBAR = "____";
    ...
    public static String chatBot(int n, String underbar) {
        ...
        System.out.println(chatBot(n-1, underbar+UNDERBAR));
        return underbar+"라고 답변하였지.";
    }
}